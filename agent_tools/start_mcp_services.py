...
class MCPServiceManager:
    def __init__(self):
        ...
        self.ports = {
            ...
            "tw_trade": int(os.getenv("TW_TRADE_HTTP_PORT", "8006")),
        }
        ...
        self.service_configs = {
            ...
            "tw_trade": {"script": os.path.join(mcp_server_dir, "tool_tw_trade.py"), "name": "TWStockTradeTools", "port": self.ports["tw_trade"]},
        }
